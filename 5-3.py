...
if "mango" in Fav_fruits:
    print("Exits on lists")
if "water-melon" in Fav_fruits:
    print("Doesn't Exists")
if "tomato" not in Fav_fruits:
    print("That is vegetable")
if "mango" in Fav_fruits and "apple" in Fav_fruits:
    print("that best combo")
if "banana" in Fav_fruits or "tomato" in Fav_fruits:
    print("unpredictable Taste!")
