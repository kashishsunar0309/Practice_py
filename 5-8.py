...
logging in again."""
print("====START---EXECISE====")
usernames = ['hari','shyam','ram','admin','sita']
for username in usernames:
  if username == "admin":
    print(f"Hello {username}, would you like to see a status report? ")
  else:
    print(f"Heelo {username},THANK YOU, For logging in again...")
...
print("====NEW---EXECISE====")
current_users = ['ravan','deepu','deep','sonzoo','sandesh']
new_users = ['ravan','deepu','lokesh','hardik','arjun']
current_user = [user1.lower() for user1 in current_users]
for users in new_users:
  if users.lower() in current_user:
    print(f"Sorry, the username '{users}' is already taken. Please enter a new username.")
  else:
